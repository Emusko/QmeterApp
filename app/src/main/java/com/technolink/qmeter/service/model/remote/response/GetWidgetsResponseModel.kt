package com.technolink.qmeter.service.model.remote.response
...
data class GetWidgetsResponseModel(
    ...
    data class Language(
        ...
        @SerializedName("labelColor") var labelColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("titleColor") var titleColor: ArrayList<Double> = arrayListOf(),
    ...
    data class CustomFieldFeedback(
        ...
        val label_text_color: ArrayList<Double>? = arrayListOf(),
        val label_bg_color: ArrayList<Double>? = arrayListOf(),
    ...
    data class PageProperties(
        @SerializedName("submit_button_txt_color") val submitButtonTxtColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("submit_button_bg_color") val submitButtonBgColor: ArrayList<Double> = arrayListOf(),
        ...
        @SerializedName("next_button_txt_color") val nextButtonTxtColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("next_button_bg_color") val nextButtonBgColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("is_back_button_enabled") val isBackButtonEnabled: Boolean? = false,
        @SerializedName("back_button_txt_color") val backButtonTxtColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("back_button_bg_color") val backButtonBgColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("page_bg") val pageBg: ArrayList<Double> = arrayListOf(),
        @SerializedName("page_header") val pageHeader: ArrayList<Double> = arrayListOf(),
        ...
        @SerializedName("page_title_text_color") val pageTitleTextColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("page_title_bg_color") val pageTitleBgColor: ArrayList<Double> = arrayListOf(),
    ...
    data class Reaction(
        ...
        @SerializedName("text_color") val textColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("text_bg_color") val textBgColor: ArrayList<Double> = arrayListOf(),
    ...
    data class MarkPageData(
        ...
        @SerializedName("bg_color") val bgColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("skip_button_text_color") val skipButtonTextColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("skip_button_bg_color") val skipButtonBgColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("submit_button_text_color") val submitButtonTextColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("submit_button_bg_color") val submitButtonBgColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("rate_icon_color") val rateIconColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("title_bg_color") val titleBgColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("title_text_color") val titleTextColor: ArrayList<Double> = arrayListOf(),
    ...
    data class Marks(
        ...
        @SerializedName("bg_color") val bgColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("text_color") val textColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("mark_border_color") val markBorderColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("mark_selected_color") val markSelectedColor: ArrayList<Double> = arrayListOf()
    ) : Serializable

    data class LanguageProperties(
        @SerializedName("page_bg") val pageBackground: ArrayList<Double> = arrayListOf(),
        @SerializedName("dimmer_color") val dimmerColor: ArrayList<Double> = arrayListOf(),
        ...
        @SerializedName("title_color") val titleColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("smiley_color") val smileyColor: ArrayList<Double> = arrayListOf(),
        ...
        @SerializedName("language_label_color") val languageLabelColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("language_label_bg_color") val languageLabelBgColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("language_label_border_color") val languageLabelBorderColor: ArrayList<Double> = arrayListOf()
    ) : Serializable
    ...
    data class SliData(
        ...
        @SerializedName("component_title_text_color") val componentTitleTextColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("component_title_size") val componentTitleSize: String? = null,
        @SerializedName("component_title_bg_color") val componentTitleBgColor: ArrayList<Double> = arrayListOf(),
    ...
    data class RateOptions(
        ...
        @SerializedName("text_color") val textColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("rate_bg_color") val rateBgColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("rate_icon_color") val rateIconColor: ArrayList<Double> = arrayListOf(),
        @SerializedName("rate_selected_color") val rateSelectedColor: ArrayList<Double> = arrayListOf()
    ...
    data class CommentAttrs(
        ...
        val text_color: ArrayList<Double>? = arrayListOf(),
        val textarea_bg_color: ArrayList<Double>? = arrayListOf(),
        val label_text_color: ArrayList<Double>? = arrayListOf(),
        val label_text_size: String? = null,
        val label_bg_color: ArrayList<Double>? = arrayListOf()
    ) : Serializable
    ...
    data class CustomerData(
        ...
        @SerializedName("component_title_bg_color") val component_title_bg_color: ArrayList<Double> = arrayListOf(),
        @SerializedName("component_title_text_color") val component_title_text_color: ArrayList<Double> = arrayListOf(),
    ...
    data class GeneralSettings(
        ...
        val policy_label: HashMap<String, String>? = hashMapOf(),
        val policy_label_color: ArrayList<Double> = arrayListOf(),
        val terms_title: HashMap<String, String>? = hashMapOf(),
        val terms_title_size: String? = null,
        val terms_description_text: String? = null,
        val submit_button_text: HashMap<String, String>? = hashMapOf(),
        val next_button_text: HashMap<String, String>? = hashMapOf(),
        val back_button_text: HashMap<String, String>? = hashMapOf()
